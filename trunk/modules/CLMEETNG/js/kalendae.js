...
var langDef = [];
    ...
    langDef['fr'] = {
        ...
        monthsShort : "Jan_Fev_Mar_Avr_Mai_Jun_Jul_Aou_Sep_Oct_Nov_Dec".split("_"),
...
Kalendae.util.domReady(function () {
    var els = util.$$('.auto-kal'),
        i = els.length,
        e,
        lang = els[0].attributes.lang.nodeValue;
        moment.lang( lang , langDef[lang] );
        Kalendae.Input.prototype.defaults.format = langDef[lang].longDateFormat.L;
    while (i--) {
        e = els[i];
        if (e.tagName === 'INPUT') {
...
Kalendae.Input.prototype = util.merge(Kalendae.prototype, {
    defaults : util.merge(Kalendae.prototype.defaults, {
        //format: 'MM/DD/YYYY',
        format: langDef['en'].longDateFormat.L,
        side: 'bottom',
        closeButton: true,
        offsetLeft: 0,
        offsetTop: 0
