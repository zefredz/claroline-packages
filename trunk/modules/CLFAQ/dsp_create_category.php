...
$output->append ( '
	<table>
		<tr>
			<td><label for="frm_category" >' . get_lang ( "Category" ) . '</label> : </td>
			<td><input class="form" name="frm_category" id="frm_category" value="' . $frm_category . '" type="text" size="53" /></td>
		</tr>
		<tr>
			<td><label for="frm_description" >' . get_lang ( "Description" ) . '</label> : </td>
			<td>
				<textarea class="form" name="frm_description" name="frm_description" cols="40" rows="8">' . $frm_description . '</textarea>
			</td>
		</tr>
		<tr>
			<td>&nbsp;</td>
