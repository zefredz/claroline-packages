...
<form id="searchUser" method="post" action="<?php echo claro_htmlspecialchars( Url::Contextualize( $_SERVER['PHP_SELF'].'?cmd=rqShowLibrarian&option=add' ) ); ?>">
    <input type="hidden" name="libraryId" value="<?php echo $this->libraryId; ?>" />
    <input type="text" name="searchString" value="" />
    <input type="submit" value="<?php echo get_lang( 'Search' ); ?>" />
    <a href="<?php echo  claro_htmlspecialchars( Url::Contextualize( $_SERVER['PHP_SELF'] . '?cmd=rqShowLibrarian&libraryId='. $this->libraryId ) );?>">
...
<div>
    ...
    <a href="<?php echo claro_htmlspecialchars( Url::Contextualize( $_SERVER['PHP_SELF'].'?cmd=exAddLibrarian&libraryId=' . $this->libraryId . '&userId='. $line[ 'userId' ] ) );?>">
