...
$_lang[ 'contributor' ] = 'contributor';
$_lang[ 'coverage' ] = 'coverage';
...
$_lang[ 'Add to the course\'s bibliography' ] = 'Add to the course\'s bibliography';
...
$_lang[ 'My bookmark' ] = 'My bookmark';
$_lang[ 'On selected items' ] = 'On selected items';
...
$_lang[ 'No libraries' ] = 'No libraries';
$_lang[ 'Error' ] = 'Error';
...
$_lang[ 'Warning : this library is not empty! First, you must delete or move all the resource within' ] = 'Warning : this library is not empty! First, you must delete or move all the resource within';
