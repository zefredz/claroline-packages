...
class CLLP_Resolver implements ModuleResourceResolver
{
    public function resolve ( ResourceLocator $locator )
    {
        $baseUrl = get_module_url('CLLP');
        ...
        if ( $locator->hasResourceId() )
        {
            ...
            {
                return get_module_entry_url('CLLP');
            }
        }
        else
        {
...
/**
 * Class CLLP Navigator
 *
 * @package CLLP
 *
 */
class CLLP_Navigator implements ModuleResourceNavigator
{
    ...
    public function isNavigable( ResourceLocator $locator )
    {
        ...
        {
            return $locator->inModule() && $locator->getModuleLabel() == 'CLLP';
        }
    }
