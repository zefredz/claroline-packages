...
// prepare html header
$htmlHeaders = '<link rel="stylesheet" type="text/css" href="' . get_module_url('GRAPPLE') . '/css/cllp.css" media="screen, projection, tv" />' . "\n"
...
$html .= '<p>' . "\n"
//- back to list
.    '<a href="'.get_module_url('GRAPPLE').'/index.php" title="'.get_lang('Back to list').'" target="_top" onClick="return exitConfirmation();">'
.    '<img src="'.get_icon_url('go-home').'" alt="'.get_lang('Back to list').'" />'
.    '</a>' . "\n"
//- tracking
.     '&nbsp;&nbsp;'
.    '<a href="'.get_module_url('GRAPPLE').'/'.(claro_is_allowed_to_edit() ? 'track_path.php?' : 'track_path_details.php?').'pathId='.$pathId.'" title="'.get_lang('View statistics').'" target="_top" onClick="return exitConfirmation();">'
