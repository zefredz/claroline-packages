...
$_lang['An error occured: the report has not been created!'] = 'Une erreur est survenue: le rapport n\' a pu être créé!';
$_lang['An error occured: the report has not been deleted!'] = 'Une erreur est survenue: le rapport n\' a  pu être supprimé!';
$_lang['Average'] = 'Moyenne';
$_lang['Back to the examination list'] = 'retour à la liste des examens';
$_lang['Back to the report list'] = 'Retour à la liste des rapports';
...
$_lang['Create a new report'] = 'Créer un nouveau rapport';
...
$_lang['Do you really want to delete this report?'] = 'Etes-vous sûr de vouloir supprimer ce rapport?';
...
$_lang['My report'] = 'Mon suivi';
$_lang['No report available'] = 'Aucun rapport disponible';
...
$_lang['Publish the report'] = 'Publier le rapport';
$_lang['Report'] = 'rapport';
$_lang['Report list'] = 'Liste des rapports';
...
$_lang['Student Monitoring Tool'] = 'Outil de suivi des étudiants';
...
$_lang['The report has been successfully created!'] = 'Le rapport a été créé avec succès!';
$_lang['The report has beeen successfully deleted!'] = 'Le rapport a été supprimé!';
...
$_lang['You don\'t have score in this report'] = 'Vous n\'avez pas de note pour ce rapport';
