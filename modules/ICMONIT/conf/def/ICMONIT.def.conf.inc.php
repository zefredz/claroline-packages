...
$conf_def['config_code'] = 'ICMONIT';
$conf_def['config_file'] = 'ICMONIT.conf.php';
$conf_def['config_name'] = 'Student Monitoring Tool';

$conf_def['section']['main']['label']      = 'Main';
$conf_def['section']['main']['description']= '';
$conf_def['section']['main']['properties'] = array ( 'ICMONIT_public_allowed' );

$conf_def_property_list[ 'ICMONIT_public_allowed' ] = array (
