...
FromKernel::uses( 'utils/input.lib'
                ...
                , 'fileUpload.lib'
                , 'course_user.lib' );
From::Module( 'ICMONIT' )->uses( 'agregator.lib'
                                 ,'assetlist.lib'
                                , 'examination.lib'
                                , 'examinationlist.lib'
                                , 'pluginloader.lib'
...
if ( $is_allowed_to_edit
  && get_conf( 'ICMONIT_public_allowed' )
  || $is_platform_admin )
{
    $actionList = array_merge( $actionList
                             , array( 'exMkPublic',
...
try
{
    ...
    switch( $cmd )
    {
        ...
        case 'rqCreate':
        {
            unset( $_SESSION[ $courseId . '_ICMONIT_item_list' ] );
            unset( $_SESSION[ $courseId . '_ICMONIT_user_list' ] );
            unset( $_SESSION[ $courseId . '_ICMONIT_mark_list' ] );
        ...
        case 'exExport2pdf':
        {
            ...
            if ( $itemList )
            {
                $_SESSION[ $courseId . '_ICMONIT_item_list' ] = $itemList;
            }
            elseif ( isset( $_SESSION[ $courseId . '_ICMONIT_item_list' ] ) )
            {
                $itemList = $_SESSION[ $courseId . '_ICMONIT_item_list' ];
            }
            
            if ( isset( $_SESSION[ $courseId . '_ICMONIT_user_list' ] ) && $cmd != 'exReset' )
            {
                $userList = $_SESSION[ $courseId . '_ICMONIT_user_list' ];
            }
            else
            {
            ...
            $reset = $cmd == 'exReset'
                  || ! isset( $_SESSION[ $courseId . '_ICMONIT_item_list' ] )
                  || ! isset( $_SESSION[ $courseId . '_ICMONIT_user_list' ] );
            ...
            if ( $userToActivate )
            {
                ...
                $report->actualize();
                $_SESSION[ $courseId . '_ICMONIT_user_list' ] = $report->getUserList();
            }
            
            if ( ! $markList && isset( $_SESSION[$courseId . '_ICMONIT_mark_list'] ) )
            {
                $markList = $_SESSION[ $courseId . '_ICMONIT_mark_list' ];
            }
            
            if ( $markList )
            {
                $_SESSION[ $courseId . '_ICMONIT_mark_list' ] = $markList;
    ...
    switch( $cmd )
    {
        ...
        case 'exMkPrivate':
        {
            ...
            $reportView = new ModuleTemplate( 'ICMONIT' , 'report_list.tpl.php' );
        ...
        case 'rqCreate':
        {
            ...
            $reportView = new ModuleTemplate( 'ICMONIT' , 'selector.tpl.php' );
        ...
        case 'rqPublish':
        {
            ...
            $reportView = new ModuleTemplate( 'ICMONIT' , 'report.tpl.php' );
        ...
        case 'exDesactivatePlugin':
        {
            ...
            $reportView = new ModuleTemplate( 'ICMONIT' , 'edit_plugin.tpl.php' );
        ...
        case 'exReport2xml' :
        {
            $reportXml = new ModuleTemplate( 'ICMONIT' , 'excel.xml.tpl.php' );
        ...
        case 'exReport2pdf' :
        {
            $reportPdf = new ModuleTemplate( 'ICMONIT' , 'report.pdf.tpl.php' );
    ...
    if ( isset( $dialog ) )
    {
        ...
        {
            $boxTemplate = new ModuleTemplate( 'ICMONIT' , $dialog . '.tpl.php');
