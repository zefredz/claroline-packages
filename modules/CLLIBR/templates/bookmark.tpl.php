...
<span> 
    <a class="claroCmd" href="<?php echo claro_htmlspecialchars( Url::Contextualize( get_module_url( 'CLLIBR' ) .'/index.php?cmd=rqShowLibrarylist' ) ); ?>">
...
<?php endif; ?>
<form method="post"
      action="<?php echo claro_htmlspecialchars( Url::Contextualize( get_module_url( 'CLLIBR' ) .'/index.php' ) );?>">
    <table class="claroTable emphaseLine" style=" width: 100%;">
        <thead>
            <tr class="headerX">
                <th>
                    <a href="<?php echo claro_htmlspecialchars( Url::Contextualize( get_module_url( 'CLLIBR' ) .'/index.php?cmd=rqShowBookmark' ) ); ?>">
                    <?php echo get_lang( 'Title'); ?>
                    </a>
                </th>
                <th>
                    <a href="<?php echo claro_htmlspecialchars( Url::Contextualize( get_module_url( 'CLLIBR' ) .'/index.php?cmd=rqShowBookmark&sort=author' ) ); ?>">
    ...
    <?php if ( ! empty( $this->resourceList ) ) : ?>
        <?php foreach ( $this->resourceList as $resource ) : ?>
            <tr>
                <td>
                    <a href="<?php echo claro_htmlspecialchars( Url::Contextualize( get_module_url( 'CLLIBR' ) .'/index.php?cmd=rqView&resourceId='. $resource[ 'id' ] ) );?>">
            ...
            <?php endif; ?>
                <td align="center">
                    <!--
                    <a href="<?php echo claro_htmlspecialchars( Url::Contextualize( get_module_url( 'CLLIBR' ) .'/index.php?cmd=exExport&resourceId='. $resource[ 'id' ] ) );?>">
                        <img src="<?php echo get_icon_url( 'export' ); ?>" alt="<?php echo get_lang( 'Export' ); ?>"/>
                    </a>
                    -->
                    <a title="<?php echo get_lang( 'Remove' ); ?>" href="<?php echo claro_htmlspecialchars( Url::Contextualize( get_module_url( 'CLLIBR' ) .'/index.php?cmd=exUnbookmark&resourceId='. $resource[ 'id' ] ) );?>">
