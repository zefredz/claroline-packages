...
$_lang['Comment for question'] = 'Comment for question';
...
$_lang['Error'] = 'Error';
$_lang['Export per user results'] = 'Export per user results';
...
$_lang['Likert scale'] = 'Likert scale';
...
$_lang['Message successfully sent'] = 'Message successfully sent';
...
$_lang['Results have been deleted'] = 'Results have been deleted';
$_lang['Results visibility for users'] = 'Results visibility for users';
$_lang['Results will be visible only at the end of the survey.'] = 'Results will be visible only at the end of the survey.';
...
$_lang['survey-results'] = 'survey-results';
...
$_lang['This survey is not accessible'] = 'This survey is not accessible';
...
$_lang['You are not allowed to see these results.'] = 'You are not allowed to see these results.';
...
$_lang['__INCOMPLETE_SURVEY_ALERT__'] = 'Some required answers are missing.\nPlease complete them.';
$_lang['__LIKERT_LEVEL_1__'] = 'Strongly agree';
$_lang['__LIKERT_LEVEL_2__'] = 'Agree';
$_lang['__LIKERT_LEVEL_3__'] = 'Neither agree nor disagree';
$_lang['__LIKERT_LEVEL_4__'] = 'Disagree';
$_lang['__LIKERT_LEVEL_5__'] = 'Strongly disagree';
$_lang['__RECALL_MESSAGE__'] = '__RECALL_MESSAGE__';
$_lang['char(s) left'] = 'char(s) left';
$_lang['or'] = 'or';

$_lang['Are you sure you want to delete results of this survey?'] = 'Are you sure you want to delete results of this survey?';
$_lang['Cannot save participation, you might have forgotten required answers'] = 'Cannot save participation, you might have forgotten required answers';
$_lang['End date'] = 'End date';
$_lang['Options'] = 'Options';
$_lang['Question successfully added to survey'] = 'Question successfully added to survey';
$_lang['Start date'] = 'Start date';
$_lang['Title is required'] = 'Title is required';
