...
<div class="LVSURVEYLine">
	<div class="LVSURVEYLineTitle">
		<?php
			if($this->editMode)
			{ 
				$urlMoveUp = 'show_survey.php?surveyLineId='.$this->surveyLine->id.'&amp;cmd=lineMoveUp';     		 
                echo claro_html_link($urlMoveUp, $arrowUpIcon);
                $urlMoveDown = 'show_survey.php?surveyLineId='.$this->surveyLine->id.'&amp;cmd=lineMoveDown';     		 
                echo claro_html_link($urlMoveDown, $arrowDownIcon);
                $urlEdit = 'edit_separator.php?surveyLineId='.$this->surveyLine->id;
                echo claro_html_link($urlEdit, $editIcon);
                $urlRemove = 'show_survey.php?surveyLineId='.$this->surveyLine->id.'&amp;cmd=lineRemove';
