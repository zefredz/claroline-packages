                    ...
                    && substr($ifchk, 0, 3) != '---' )
                {
                    ...
                    if ($this->_lastIndent == $node->indent)
                    {
                        ...
                        else
                        {
                            ...
                            if (! is_null ($this->_allNodes[$this->_lastNode] ) )
                            {
                    ...
                    if ($this->_inBlock === false)
                    {
                        ...
                        if (((is_array($node->data)) && (!is_array($node->data[key($node->data)])) )
