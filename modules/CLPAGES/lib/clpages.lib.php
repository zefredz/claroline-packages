...
abstract class Component
{
    ...
    public function renderBlock()
    {
        ...
        if ($this->isTitleVisible() || claro_is_allowed_to_edit())
        {
            ...
            if (claro_is_allowed_to_edit())
            {
                ...
                {
                    $out .=
                        '<a rel="popup" href="lib/s5/s5.php?pageId=' . $this->getPageId() . '&componentId=' . $this->getId() . '" class="s5ViewerCmd">' . claro_html_icon('slide', null, get_lang('View')) . '</a>'
                        . '&nbsp;';
                }
    ...
    public function renderEditor()
    {
        $out =
            ...
            . '<div id="errorMessage_' . $this->getId() . '"></div>' . "\n"
        ...
        // title
        $out .='<label for="title_' . $this->getId() . '">' . get_lang('Title') . '</label><br />' . "\n"
            ...
            . '<input type="button" id="bCancel_' . $this->getId() . '" value="' . get_lang('Cancel') . '"/>&nbsp;' . "\n"
            . '</form>' . "\n"
            . ' </div>' . "\n"
        ;
        return $out;
