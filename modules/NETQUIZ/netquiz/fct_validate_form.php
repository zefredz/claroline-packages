...
# Retourne false si la chaîne n'est pas vide
...
# Retourne false si la chaîne ne contient pas plus de $nbr caractères
# Retourne true si la chaîne contient plus de $nbr caractères
...
# Retourne true si la valeur correspond à une date valide
# Retourne false si la valeur ne correspond pas à une date valide
...
# Retourne true si $date1 est inférieure à $date2
# Retourne false si $date1 est supérieure ou égale à $date2
# Les deux dates doivent être valides et être passées au format dd/mm/yyyy !
...
# Retourne true si la valeur correspond à une adresse email valide
# Retourne false si la valeur ne correspond pas à une adresse email valide
...
# Retourne true si la valeur correspond à une adresse url valide
# Retourne false si la valeur ne correspond pas à une adresse url valide
...
# Retourne O si la valeur ne correspond pas à un nombre valide
# Retourne 1 si la valeur correspond à un nombre valide
# Retourne 2 si la valeur correspond à un nombre entier
